...
import com.bingo.widget.contactsview.indexableview.database.DataObserver;
import com.bingo.widget.contactsview.indexableview.database.HeaderFooterDataObserver;
import com.bingo.widget.contactsview.indexableview.database.IndexBarDataObserver;
...
public class IndexableLayout extends FrameLayout {
    ...
    private float mBarTextSize, mBarTextSpace, mBarWidth,mBarHeight;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.IndexableLayout);
            mBarTextColor = a.getColor(R.styleable.IndexableLayout_indexBar_textColor, ContextCompat.getColor(context, R.color.default_indexBar_textColor));
            mBarTextSize = a.getDimension(R.styleable.IndexableLayout_indexBar_textSize, getResources().getDimension(R.dimen.default_indexBar_textSize));
            mBarFocusTextColor = a.getColor(R.styleable.IndexableLayout_indexBar_selectedTextColor, ContextCompat.getColor(context, R.color.default_indexBar_selectedTextColor));
            mBarTextSpace = a.getDimension(R.styleable.IndexableLayout_indexBar_textSpace, getResources().getDimension(R.dimen.default_indexBar_textSpace));
            mBarBg = a.getDrawable(R.styleable.IndexableLayout_indexBar_background);
            mBarWidth = a.getDimension(R.styleable.IndexableLayout_indexBar_layout_width, getResources().getDimension(R.dimen.default_indexBar_layout_width));
            mBarHeight = a.getDimension(R.styleable.IndexableLayout_indexBar_layout_height,getResources().getDimension(R.dimen.default_indexBar_layout_height));
            a.recycle();
        }
...
//        LayoutParams params = new LayoutParams((int) mBarWidth, LayoutParams.WRAP_CONTENT);
        LayoutParams params = new LayoutParams((int) mBarWidth, (int)mBarHeight);
    ...
    public static String trim(String input){
        ...
        input = input.trim();
        while (input.startsWith("　")) {//这里判断是不是全角空格
