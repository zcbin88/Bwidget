...
import com.bingo.widget.model.Point;
...
public class SignatureView extends View {
    ...
    public SignatureView(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(
                attrs, R.styleable.SignatureView, 0, 0);

        try {
            backgroundColor = typedArray.getColor(R.styleable.SignatureView_backgroundColor,
                    context.getResources().getColor(R.color.white));
            penColor = typedArray.getColor(R.styleable.SignatureView_penColor,
                    context.getResources().getColor(R.color.penRoyalBlue));
            penSize = typedArray.getDimension(R.styleable.SignatureView_penSize,
                    context.getResources().getDimension(R.dimen.pen_size));
            enableSignature = typedArray.getBoolean(R.styleable.SignatureView_enableSignature, true);
        } finally {
            typedArray.recycle();
        }
...
//            canvasBmp.drawRect(left,top,right,bottom,mPaint);
